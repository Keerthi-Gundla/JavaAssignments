...
public class StudentMain {
    public static void getInput(List<Student> students){
    ...
    public static void main(String args[]){
        ...
        studentOperations.printDepartments(students);
        System.out.println();

        System.out.println("students enrolled after 2018 : ");
        studentOperations.studentsEnrolledAfter2018(students);
        System.out.println();

        System.out.println("Male student details : ");
        studentOperations.printMaleStudentsDetails(students);
        System.out.println();

        System.out.println();
        studentOperations.printNoOFStudents(students);

        System.out.println();
        studentOperations.avgAgeOfStudents(students);

        System.out.println();
        studentOperations.printHighestPercentageStudentDetails(students);

        System.out.println();
        studentOperations.noOfStudentsInDepartment(students);

        System.out.println();
        studentOperations.printAveragePercentageDepWise(students);

        System.out.println();
        studentOperations.printYoungestStudent("Electronic",students);

        System.out.println();
        studentOperations.studentsInComputerScience(students);
    }
}
